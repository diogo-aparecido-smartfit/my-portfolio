...
export default function ProjectCard({ language, projects }: ProjectCardProps) {
  ...
  return (
    <>
      ...
      {isModalOpen ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none shadow-2xl bg-zinc-900/90">
            <div className="relative mx-2 lg:scale-100 w-auto my-6 max-w-7xlxl ">
              ...
              >
                    ...
                    <div className="flex gap-2 items-center ml-4 transition-all">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="group/edit flex items-center justify-center bg-[#ED6A5F] rounded-full w-[12px] h-[12px] hover:brightness-50 transition-all"
                        >
                        ...
                        <button
                          onClick={() => setIsModalOpen(false)}
                          className="group/edit flex items-center justify-center bg-[#F5BF4F] rounded-full w-[12px] h-[12px] hover:brightness-50 transition-all"
                        >
                          <span className="hidden group-hover/edit:flex font-bold text-yellow-700">
                            -
                          </span>
                        </button>
                        <button className="group/edit flex items-center justify-center bg-[#61C554] rounded-full w-[12px] h-[12px] hover:brightness-50 transition-all"></button>
                      </div>
                      <div className="flex gap-1 ml-6 items-center">
                        <img
                          className={`hover:brightness-[.1] cursor-pointer transition-all ${
                            localStorage.getItem("darkMode") === "true"
                              ? "brightness-100"
                              : "brightness-[.2]"
                          }`}
                        ...
                        <span className="text-xs hover:brightness-50 cursor-pointer transition-all">
                          <IoIosArrowDown />
                        </span>
                      </div>
                      <div className="flex ml-1 transition-all hover:brightness-50 cursor-pointer">
                        <IoIosArrowBack />
                      </div>
                    </div>

                    <div className="flex gap-3 items-center ml-2 mr-4">
                      <button className=" transition-all hover:brightness-50 cursor-pointer">
                        <IoShareOutline />
                      </button>
                      <button className=" transition-all hover:brightness-50 cursor-pointer">
                ...
                {/* mobile header */}
                <header className="md:hidden w-full flex items-center flex-col h-[132px] bg-[#313131] rounded-b-xl shadow-navShadow">
                  <div className="flex mt-[7px] max-w-[334px] min-w-[334px] items-center justify-between px-3 bg-[#4B4B4B] shadow-sm h-[44px] rounded-xl">
